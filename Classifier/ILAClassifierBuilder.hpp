...
namespace Classifier::ILA
{
	...
	public:
		...
		struct Builder {
			ILAClassifier<Class, sizeof...(Ts)> operator()(Classes<Class>& classes, Features<Ts...>& features)
			{
				...
				return ILAClassifier<Class, sizeof...(Ts)>(classCardinality, featuresCardinality);
			}
		};
	...
	public:
		...
		template<typename Class, typename ...Ts>
		static ILAClassifier<Class, sizeof...(Ts)> from(
